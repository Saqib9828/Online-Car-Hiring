<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Swift.aspx.cs" Inherits="OCHS.Swift" %>
...
<div class="a" 
 ...
 <p style="color: #FFFFFF; font-size: medium; width: 98%; height: 100%; background-color: #203E34;">This is Maruti Swift fuel efficient car and it runs on both types of fuel petrol an diesel<br/>
...
<div class="b" 
    ...
    <asp:Image ID="Image2" runat="server" Height="100%" 
        ImageUrl="~/Styles/Swift.png" Width="100%" />
    </div>
