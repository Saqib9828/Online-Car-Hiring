<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Honda.aspx.cs" Inherits="OCHS.Honda" %>
...
<div class="a" 
 ...
 <p style="color: #FFFFFF; font-size: medium; width: 98%; height: 100%; background-color: #203E34;">This is Honda city fuel efficient car and it runs on both types of fuel petrol an diesel<br/>
    ...
    <asp:Image ID="Image2" runat="server" Height="100%" 
        ImageUrl="~/Styles/honda.jpg" Width="100%" />
    </div>
</asp:Content>
